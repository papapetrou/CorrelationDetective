...
public class configurationParameters {
    ...
    public configurationParameters(double[][] data, String metric, double tau, double minJump, double start_epsilon, double epsilon_multiplier,
